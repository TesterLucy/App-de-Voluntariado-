...
document.getElementById('cancelButton').addEventListener('click', function () {
    ...
    window.location.href = '../html/wellcome.html'; // Cambia 'voluntariado_normal.html' por tu página de voluntariado normal
});
document.getElementById('forgotPasswordButton').addEventListener('click', function () {
    document.getElementById('loginForm').reset();
    window.location.href = '../html/forgotpass.html'; // Cambia 'voluntariado_normal.html' por tu página de voluntariado normal
});
